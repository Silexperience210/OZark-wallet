...
type Screen = "welcome" | "create" | "import" | "unlock" | "dashboard" | "backup" | "taproot" | "lightning" | "ark" | "history" | "market" | "gateway";
    ...
    <div className="app-container">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {screen === "gateway" && (
            <Gateway onBack={() => setScreen("dashboard")} />
          )}
          {screen === "backup" && (
